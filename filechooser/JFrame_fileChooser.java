...
public class JFrame_fileChooser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtaTexto.setBackground(new java.awt.Color(0, 0, 0));
        ...
        pnlSeparador.setBackground(new java.awt.Color(51, 51, 51));
    ...
    private void meniAbrirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_meniAbrirActionPerformed
            //Abrir archivo...
        JFileChooser escojedor = new JFileChooser();
        int seleccion = escojedor.showOpenDialog(null);
        if(seleccion == JFileChooser.APPROVE_OPTION){
            archivo = escojedor.getSelectedFile();
            try{
    ...
    private void meniCreadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_meniCreadorActionPerformed
        JOptionPane.showMessageDialog(null,"Sebitas serrano R.");
